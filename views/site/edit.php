        ...
        <div class="card-body p-5">
            ...
            <form action="#" method="post">
                ...
                <div class="form-outline mb-4">
                    ...
                    <input type="text" name="name" value="<?php echo $taskItem['name']; ?>" class="form-control form-control-lg">
                ...
                <div class="form-outline mb-4">
                    ...
                    <textarea name="description" class="form-control form-control-lg"><?php echo $taskItem['description']; ?></textarea>
                    <div class="form-notch"><div class="form-notch-leading" style="width: 9px;"></div><div class="form-notch-middle" style="width: 71.2px;"></div><div class="form-notch-trailing"></div></div></div>
